...
public class InvertedIndexerReducer extends TableReducer<ImmutableBytesWritable, IntWritable, ImmutableBytesWritable> {
    ...
    public void reduce(ImmutableBytesWritable key, Iterable<IntWritable> values, Context context)
        ...
        if (!currentWord.equals(word) && !currentWord.equals(" ")) {
            ...
            multipleOutputs.write(context.getConfiguration().get("HDFSOutputFileName"), new Text(currentWord+", "), new Text(out.toString()), context.getConfiguration().get("HDFSOutputPath"));
